...
class MutationCalling:
	...
	def gatk_variantion_filter(self):
		...
		#step1 = ' \\\n'.join(['java -Xmx6g -jar '+os.path.join(self.gatkDIR,'GenomeAnalysisTK.jar'),
			  ...
			  #'-resource:hapmap,known=false,training=true,truth=true,prior=15.0 Cancer_pipeline_test/new_pip/hapmap_3.3.hg19.vcf',
			  ##'-resource:omni,known=false,training=true,truth=true,prior=12.0 omni.vcf',
			  ##'-resource:1000G,known=false,training=true,truth=false,prior=10.0 1000G.vcf',
			  #'-resource:dbsnp,known=true,training=false,truth=false,prior=2.0 Cancer_pipeline_test/new_pip/00-All.vcf',
			  #'-an DP',
			  #'-an QD',
			  #'-an FS',
			  #'-an MQRankSum',
		...
		#step3 = ' \\\n'.join(['java -Xmx6g -jar '+os.path.join(self.gatkDIR,'GenomeAnalysisTK.jar'),
			  ...
			  #'-resource:mills,known=true,training=true,truth=true,prior=12.0 Cancer_pipeline_test/new_pip/Mills_and_1000G_gold_standard.indels.b37.vcf',
			  #'-an DP',
			  #'-an FS',
			  #'-an MQRankSum',
			  #'-an ReadPosRankSum',
